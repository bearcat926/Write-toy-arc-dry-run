...
```bash
pytest tests/ -v
# Results: see docs/phase2_test_baseline.generated.md (generated by tools/verify_test_baseline.py)
```

### Skipped Tests

See `docs/phase2_test_baseline.generated.md` for the full skipped test list.
All skipped tests use `os.symlink()` which requires admin privileges on Windows.
...
- [x] All tests pass (see docs/phase2_test_baseline.generated.md), skipped tests are Windows symlinks
